...
// _inCAAAAhX45 : C++() ==> C(Camera const *)
extern int Camera$42$get_type(Camera const *self);

// _inCAAAAz6kI : C++() ==> C(Camera *)
...
// _inCAAAA4GrH : C++(Engine const &) ==> C(Engine const *)
extern Engine * Engine$2$Engine(Engine const *arg0);

// _inCAAAAw9bJ : C++() ==> C(Engine *)
...
// _inCAAAARIEu : C++() ==> C(Engine *)
extern int Engine$6$HelloEngine(Engine *self);

// _inCAAAAu07o : C++(int i, std::string s, bool b) ==> C(Engine *, int, char const *, bool)
extern int Engine$7$casetest(Engine *self, int i, char const *s, bool b);

// _inCAAAAFoZ4 : C++(char const *filename) ==> C(Engine *, char const *)
extern NodePath * Engine$8$load_model(Engine *self, char const *filename);

// _inCAAAASkdf : C++(GeomVertexData *data, char const *gvw_name) ==> C(Engine *, GeomVertexData *, char const *)
extern GeomVertexWriter * Engine$9$new_GeomVertexWriter(Engine *self, GeomVertexData *data, char const *gvw_name);

// _inCAAAA_O4M : C++(Geom *geom, GeomTriangles *pri) ==> C(Engine *, Geom *, GeomTriangles *)
...
// _inCAAAAvNOt : C++(std::string const &filename) ==> C(char const *)
extern Filename * Filename$9$text_filename(char const *filename);

// _inCAAAAbJPp : C++(Filename const &filename) ==> C(Filename const *)
extern Filename * Filename$10$binary_filename(Filename const *filename);

// _inCAAAAPh6h : C++(std::string const &filename) ==> C(char const *)
extern Filename * Filename$11$binary_filename(char const *filename);

// _inCAAAACpRv : C++(std::string const &filename) ==> C(char const *)
extern Filename * Filename$12$dso_filename(char const *filename);

// _inCAAAANs6u : C++(std::string const &filename) ==> C(char const *)
extern Filename * Filename$13$executable_filename(char const *filename);

// _inCAAAAxSOe : C++(std::string const &filename) ==> C(char const *)
extern Filename * Filename$14$pattern_filename(char const *filename);

// _inCAAAAaIaB : C++(std::string const &os_specific, Filename::Type type) ==> C(char const *, Filename::Type)
extern Filename * Filename$15$from_os_specific(char const *os_specific, Filename$_Type type);

// _inCAAAAEvxv : C++(std::string const &os_specific) ==> C(char const *)
extern Filename * Filename$16$from_os_specific(char const *os_specific);

// _inCAAAAOwIH : C++(std::wstring const &os_specific, Filename::Type type) ==> C(wchar_t const *, Filename::Type)
extern Filename * Filename$17$from_os_specific_w(wchar_t const *os_specific, Filename$_Type type);

// _inCAAAAVnxx : C++(std::wstring const &os_specific) ==> C(wchar_t const *)
extern Filename * Filename$18$from_os_specific_w(wchar_t const *os_specific);

// _inCAAAASufR : C++(std::string const &user_string, Filename::Type type) ==> C(char const *, Filename::Type)
extern Filename * Filename$19$expand_from(char const *user_string, Filename$_Type type);

// _inCAAAABIso : C++(std::string const &user_string) ==> C(char const *)
extern Filename * Filename$20$expand_from(char const *user_string);

// _inCAAAAWnrq : C++(std::string const &dirname, std::string const &prefix, std::string const &suffix, Filename::Type type) ==> C(char const *, char const *, char const *, Filename::Type)
extern Filename * Filename$21$temporary(char const *dirname, char const *prefix, char const *suffix, Filename$_Type type);

// _inCAAAAkS5B : C++(std::string const &dirname, std::string const &prefix, std::string const &suffix) ==> C(char const *, char const *, char const *)
extern Filename * Filename$22$temporary(char const *dirname, char const *prefix, char const *suffix);

// _inCAAAAwIqG : C++(std::string const &dirname, std::string const &prefix) ==> C(char const *, char const *)
...
// _inCAAAA83u8 : C++(pofstream &stream, bool truncate) ==> C(Filename const *, pofstream *, bool)
extern bool Filename$91$open_write(Filename const *self, pofstream *stream, bool truncate);

// _inCAAAARGVH : C++(pofstream &stream) ==> C(Filename const *, pofstream *)
extern bool Filename$92$open_write(Filename const *self, pofstream *stream);

// _inCAAAARfnm : C++(std::ofstream &stream, bool truncate) ==> C(Filename const *, std::ofstream *, bool)
...
// _inCAAAAXpRT : C++(std::ofstream &stream) ==> C(Filename const *, std::ofstream *)
...
// _inCAAAAjFAU : C++(pofstream &stream) ==> C(Filename const *, pofstream *)
extern bool Filename$95$open_append(Filename const *self, pofstream *stream);

// _inCAAAAttUT : C++(std::ofstream &stream) ==> C(Filename const *, std::ofstream *)
...
// _inCAAAA5Jdf : C++(pfstream &stream, bool truncate) ==> C(Filename const *, pfstream *, bool)
extern bool Filename$97$open_read_write(Filename const *self, pfstream *stream, bool truncate);

// _inCAAAAv_IM : C++(pfstream &stream) ==> C(Filename const *, pfstream *)
extern bool Filename$98$open_read_write(Filename const *self, pfstream *stream);

// _inCAAAAmwiS : C++(std::fstream &stream, bool truncate) ==> C(Filename const *, std::fstream *, bool)
...
// _inCAAAAxoXJ : C++(std::fstream &stream) ==> C(Filename const *, std::fstream *)
...
// _inCAAAAwbx_ : C++(pfstream &stream) ==> C(Filename const *, pfstream *)
extern bool Filename$101$open_read_append(Filename const *self, pfstream *stream);

// _inCAAAAdXEn : C++(std::fstream &stream) ==> C(Filename const *, std::fstream *)
...
// _inCAAAApzNO : C++(BamWriter *manager, Datagram &dg) ==> C(Geom *, BamWriter *, Datagram *)
extern void Geom$75$write_datagram(Geom *self, BamWriter *manager, Datagram *dg);

// _inCAAAAtOLt : C++(BamReader *manager) ==> C(Geom *, BamReader *)
...
// _inCAAAAJan9 : C++() ==> C(Geom const *)
extern int Geom$79$get_type(Geom const *self);

// _inCAAAA_fQQ : C++() ==> C(Geom *)
...
// _inCAAAAxxGd : C++(GeomEnums const &) ==> C(GeomEnums const *)
extern GeomEnums * GeomEnums$2$GeomEnums(GeomEnums const *arg0);

// _inCAAAAcioB : C++() ==> C(GeomEnums *)
...
// _inCAAAA4m3E : C++(std::string const &name) ==> C(char const *)
extern GeomNode * GeomNode$1$GeomNode(char const *name);

// _inCAAAAVy6F : C++(AccumulatedAttribs const &attribs, int attrib_types, GeomTransformer &transformer) ==> C(GeomNode *, AccumulatedAttribs const *, int, GeomTransformer *)
...
// _inCAAAA2Tj5 : C++(LMatrix4 const &mat) ==> C(GeomNode *, LMatrix4 const *)
extern void GeomNode$3$xform(GeomNode *self, LMatrix4 const *mat);

// _inCAAAAclSe : C++() ==> C(GeomNode const *)
extern bool GeomNode$4$is_renderable(GeomNode const *self);

// _inCAAAA2cJJ : C++(CullTraverser *trav, CullTraverserData &data) ==> C(GeomNode *, CullTraverser *, CullTraverserData *)
extern void GeomNode$5$add_for_draw(GeomNode *self, CullTraverser *trav, CullTraverserData *data);

// _inCAAAAGddz : C++() ==> C(GeomNode const *)
extern bool GeomNode$6$safe_to_flatten(GeomNode const *self);

// _inCAAAA2zaj : C++() ==> C(GeomNode const *)
extern bool GeomNode$7$safe_to_combine(GeomNode const *self);

// _inCAAAAVFmF : C++(GraphicsStateGuardianBase *gsg, RenderState const *node_state, GeomTransformer &transformer, Thread *current_thread) ==> C(GeomNode *, GraphicsStateGuardianBase *, RenderState const *, GeomTransformer *, Thread *)
...
// _inCAAAAwpGv : C++(GraphicsStateGuardianBase *gsg, RenderState const *node_state, GeomTransformer &transformer) ==> C(GeomNode *, GraphicsStateGuardianBase *, RenderState const *, GeomTransformer *)
...
// _inCAAAA4Lsu : C++() ==> C(GeomPrimitive const *)
extern char ** GeomPrimitive$87$make_index_data(GeomPrimitive const *self);

// _inCAAAA01_y : C++(GraphicsStateGuardianBase *gsg, GeomPrimitivePipelineReader const *reader, bool force) ==> C(GeomPrimitive const *, GraphicsStateGuardianBase *, GeomPrimitivePipelineReader const *, bool)
...
// _inCAAAADKdV : C++(BamWriter *manager, Datagram &dg) ==> C(GeomPrimitive *, BamWriter *, Datagram *)
extern void GeomPrimitive$89$write_datagram(GeomPrimitive *self, BamWriter *manager, Datagram *dg);

// _inCAAAAnnbx : C++(BamReader *manager) ==> C(GeomPrimitive *, BamReader *)
...
// _inCAAAAe2dz : C++() ==> C(GeomPrimitive const *)
...
// _inCAAAAlM_V : C++(GeomEnums::UsageHint usage_hint) ==> C(GeomEnums::UsageHint)
extern GeomTriangles * GeomTriangles$1$GeomTriangles(GeomEnums$_UsageHint usage_hint);

// _inCAAAAl_JA : C++(GeomTriangles const &copy) ==> C(GeomTriangles const *)
...
// _inCAAAALmT7 : C++(GraphicsStateGuardianBase *gsg, GeomPrimitivePipelineReader const *reader, bool force) ==> C(GeomTriangles const *, GraphicsStateGuardianBase *, GeomPrimitivePipelineReader const *, bool)
...
// _inCAAAAFly7 : C++() ==> C(GeomTriangles const *)
...
// _inCAAAAkRv_ : C++() ==> C(GeomVertexData *)
extern CopyOnWriteObject * GeomVertexData$1$upcast_to_CopyOnWriteObject(GeomVertexData *self);

// _inCAAAAVY07 : C++() ==> C(GeomVertexData *)
extern GeomEnums * GeomVertexData$2$upcast_to_GeomEnums(GeomVertexData *self);

// _inCAAAAKRDk : C++(GeomVertexData const &copy) ==> C(GeomVertexData const *)
extern GeomVertexData * GeomVertexData$3$GeomVertexData(GeomVertexData const *copy);

// _inCAAAARp_z : C++(GeomVertexData const &copy, GeomVertexFormat const *format) ==> C(GeomVertexData const *, GeomVertexFormat const *)
extern GeomVertexData * GeomVertexData$4$GeomVertexData(GeomVertexData const *copy, GeomVertexFormat const *format);

// _inCAAAAQDxG : C++(std::string const &name, GeomVertexFormat const *format, GeomEnums::UsageHint usage_hint) ==> C(char const *, GeomVertexFormat const *, GeomEnums::UsageHint)
...
// _inCAAAATi_p : C++(GeomVertexData const *source, bool keep_data_objects) ==> C(GeomVertexData *, GeomVertexData const *, bool)
extern void GeomVertexData$41$copy_from(GeomVertexData *self, GeomVertexData const *source, bool keep_data_objects);

// _inCAAAA6qtd : C++(int dest_row, GeomVertexData const *source, int source_row, Thread *current_thread) ==> C(GeomVertexData *, int, GeomVertexData const *, int, Thread *)
...
// _inCAAAAUeFN : C++(GeomVertexFormat const *new_format) ==> C(GeomVertexData const *, GeomVertexFormat const *)
extern char ** GeomVertexData$43$convert_to(GeomVertexData const *self, GeomVertexFormat const *new_format);

// _inCAAAAEt8J : C++(LVecBase4 const &color_scale) ==> C(GeomVertexData const *, LVecBase4 const *)
extern char ** GeomVertexData$44$scale_color(GeomVertexData const *self, LVecBase4 const *color_scale);

// _inCAAAAAQUA : C++(LVecBase4 const &color_scale, int num_components, GeomEnums::NumericType numeric_type, GeomEnums::Contents contents) ==> C(GeomVertexData const *, LVecBase4 const *, int, GeomEnums::NumericType, GeomEnums::Contents)
...
// _inCAAAAo88V : C++(LColor const &color) ==> C(GeomVertexData const *, LColor const *)
extern char ** GeomVertexData$46$set_color(GeomVertexData const *self, LColor const *color);

// _inCAAAAfzCR : C++(LColor const &color, int num_components, GeomEnums::NumericType numeric_type, GeomEnums::Contents contents) ==> C(GeomVertexData const *, LColor const *, int, GeomEnums::NumericType, GeomEnums::Contents)
...
// _inCAAAApzio : C++() ==> C(GeomVertexData const *)
extern char ** GeomVertexData$48$reverse_normals(GeomVertexData const *self);

// _inCAAAANBVp : C++(bool force, Thread *current_thread) ==> C(GeomVertexData const *, bool, Thread *)
extern char ** GeomVertexData$49$animate_vertices(GeomVertexData const *self, bool force, Thread *current_thread);

// _inCAAAAd9F_ : C++() ==> C(GeomVertexData *)
extern void GeomVertexData$50$clear_animated_vertices(GeomVertexData *self);

// _inCAAAAiw96 : C++(LMatrix4 const &mat) ==> C(GeomVertexData *, LMatrix4 const *)
extern void GeomVertexData$51$transform_vertices(GeomVertexData *self, LMatrix4 const *mat);

// _inCAAAAT_7D : C++(LMatrix4 const &mat, SparseArray const &rows) ==> C(GeomVertexData *, LMatrix4 const *, SparseArray const *)
extern void GeomVertexData$52$transform_vertices(GeomVertexData *self, LMatrix4 const *mat, SparseArray const *rows);

// _inCAAAAgdzG : C++(LMatrix4 const &mat, int begin_row, int end_row) ==> C(GeomVertexData *, LMatrix4 const *, int, int)
extern void GeomVertexData$53$transform_vertices(GeomVertexData *self, LMatrix4 const *mat, int begin_row, int end_row);

// _inCAAAAwwi1 : C++(InternalName *name, int num_components, GeomEnums::NumericType numeric_type, GeomEnums::Contents contents) ==> C(GeomVertexData const *, InternalName *, int, GeomEnums::NumericType, GeomEnums::Contents)
...
// _inCAAAA8HIM : C++(BamWriter *manager, Datagram &dg) ==> C(GeomVertexData *, BamWriter *, Datagram *)
extern void GeomVertexData$71$write_datagram(GeomVertexData *self, BamWriter *manager, Datagram *dg);

// _inCAAAAAdKg : C++() ==> C(GeomVertexData const *)
extern bool GeomVertexData$72$require_fully_complete(GeomVertexData const *self);

// _inCAAAASM2H : C++(BamReader *manager) ==> C(GeomVertexData *, BamReader *)
...
// _inCAAAA0V7R : C++(GeomVertexArrayFormat const *array_format) ==> C(GeomVertexArrayFormat const *)
extern GeomVertexFormat * GeomVertexFormat$4$GeomVertexFormat(GeomVertexArrayFormat const *array_format);

// _inCAAAAekha : C++(GeomVertexFormat const &copy) ==> C(GeomVertexFormat const *)
...
// _inCAAAAwY7m : C++() ==> C(GeomVertexFormat const *)
extern bool GeomVertexFormat$6$unref(GeomVertexFormat const *self);

// _inCAAAAYvVU : C++() ==> C(GeomVertexFormat const *)
extern bool GeomVertexFormat$7$is_registered(GeomVertexFormat const *self);

// _inCAAAAnlvK : C++(GeomVertexArrayFormat const *format) ==> C(GeomVertexArrayFormat const *)
extern char ** GeomVertexFormat$8$register_format(GeomVertexArrayFormat const *format);

// _inCAAAAF5LQ : C++(GeomVertexFormat const *format) ==> C(GeomVertexFormat const *)
...
// _inCAAAAj4hI : C++(BamWriter *manager, Datagram &dg) ==> C(GeomVertexFormat *, BamWriter *, Datagram *)
...
// _inCAAAAvl3_ : C++() ==> C(GeomVertexFormat const *)
extern int GeomVertexFormat$73$get_type(GeomVertexFormat const *self);

// _inCAAAA0Ul6 : C++() ==> C(GeomVertexFormat *)
extern int GeomVertexFormat$74$force_init_type(GeomVertexFormat *self);


// GeomVertexWriter

// _inCAAAADYGf : C++(GeomVertexArrayData *array_data, Thread *current_thread) ==> C(GeomVertexArrayData *, Thread *)
extern GeomVertexWriter * GeomVertexWriter$1$GeomVertexWriter(GeomVertexArrayData *array_data, Thread *current_thread);

// _inCAAAAm1bv : C++(GeomVertexArrayData *array_data) ==> C(GeomVertexArrayData *)
extern GeomVertexWriter * GeomVertexWriter$2$GeomVertexWriter(GeomVertexArrayData *array_data);

// _inCAAAABk28 : C++(GeomVertexArrayData *array_data, int column, Thread *current_thread) ==> C(GeomVertexArrayData *, int, Thread *)
...
// _inCAAAA8wdd : C++(GeomVertexArrayData *array_data, int column) ==> C(GeomVertexArrayData *, int)
extern GeomVertexWriter * GeomVertexWriter$4$GeomVertexWriter(GeomVertexArrayData *array_data, int column);

// _inCAAAAdgbd : C++(GeomVertexData *vertex_data, CPT_InternalName name, Thread *current_thread) ==> C(GeomVertexData *, CPT_InternalName *, Thread *)
...
// _inCAAAAiuVb : C++(GeomVertexData *vertex_data) ==> C(GeomVertexData *)
...
// _inCAAAAWOrH : C++(Thread *current_thread) ==> C(Thread *)
...
// _inCAAAAFeUd : C++(InternalName *column, std::string const &slider) ==> C(InternalName *, char const *)
...
// _inCAAAAV26P : C++(BamWriter *manager, Datagram &me) ==> C(InternalName *, BamWriter *, Datagram *)
extern void InternalName$37$write_datagram(InternalName *self, BamWriter *manager, Datagram *me);

// _inCAAAAmP2E : C++(BamReader *manager) ==> C(InternalName *, BamReader *)
...
// _inCAAAAQn6E : C++() ==> C(InternalName const *)
...
// _inCAAAA5NlT : C++(LVecBase2f const &copy, float z) ==> C(LVecBase2f const *, float)
extern LVecBase3f * LVecBase3f$2$LVecBase3f(LVecBase2f const *copy, float z);

// _inCAAAARRmU : C++(LVecBase3f const &) ==> C(LVecBase3f const *)
extern LVecBase3f * LVecBase3f$3$LVecBase3f(LVecBase3f const *arg0);

// _inCAAAAEwwu : C++(LVecBase3f::EVector3 const &v) ==> C(LVecBase3f::EVector3 const *)
...
// _inCAAAABPuZ : C++(float fill_value) ==> C(float)
extern LVecBase3f * LVecBase3f$5$LVecBase3f(float fill_value);

// _inCAAAAnj6v : C++(float x, float y, float z) ==> C(float, float, float)
...
// _inCAAAAsbyG : C++(NodePath &&from) ==> C(NodePath *)
extern NodePath * NodePath$2$NodePath(NodePath *from);

// _inCAAAAJaJj : C++(NodePath const &copy) ==> C(NodePath const *)
extern NodePath * NodePath$3$NodePath(NodePath const *copy);
// COLLISION : NodePath_C_ctor_p_p NodePath$3$NodePath

// _inCAAAAvecb : C++(NodePath const &parent, PandaNode *child_node, Thread *current_thread) ==> C(NodePath const *, PandaNode *, Thread *)
extern NodePath * NodePath$4$NodePath(NodePath const *parent, PandaNode *child_node, Thread *current_thread);

// _inCAAAAnAhm : C++(NodePath const &parent, PandaNode *child_node) ==> C(NodePath const *, PandaNode *)
extern NodePath * NodePath$5$NodePath(NodePath const *parent, PandaNode *child_node);

// _inCAAAAGF9J : C++(PandaNode *node, Thread *current_thread) ==> C(PandaNode *, Thread *)
...
// _inCAAAAMd52 : C++() ==> C(NodePath const *)
extern RenderState const * NodePath$98$get_state(NodePath const *self);

// _inCAAAAIp0D : C++(NodePath const &other, RenderState const *state, Thread *current_thread) ==> C(NodePath *, NodePath const *, RenderState const *, Thread *)
extern void NodePath$99$set_state(NodePath *self, NodePath const *other, RenderState const *state, Thread *current_thread);

// _inCAAAAojNF : C++(NodePath const &other, RenderState const *state) ==> C(NodePath *, NodePath const *, RenderState const *)
extern void NodePath$100$set_state(NodePath *self, NodePath const *other, RenderState const *state);

// _inCAAAADhE4 : C++(RenderState const *state, Thread *current_thread) ==> C(NodePath *, RenderState const *, Thread *)
...
// _inCAAAAH5x7 : C++() ==> C(NodePath *)
extern void NodePath$124$clear_transform(NodePath *self);

// _inCAAAAV_k2 : C++(NodePath const &other, TransformState const *transform, Thread *current_thread) ==> C(NodePath *, NodePath const *, TransformState const *, Thread *)
...
// _inCAAAAOC4G : C++(NodePath const &other, TransformState const *transform) ==> C(NodePath *, NodePath const *, TransformState const *)
extern void NodePath$126$set_transform(NodePath *self, NodePath const *other, TransformState const *transform);

// _inCAAAACDwY : C++(TransformState const *transform, Thread *current_thread) ==> C(NodePath *, TransformState const *, Thread *)
...
// _inCAAAAaXOe : C++() ==> C(NodePath const *)
extern TransformState const * NodePath$134$get_prev_transform(NodePath const *self);

// _inCAAAAbxkj : C++(NodePath const &other, TransformState const *transform, Thread *current_thread) ==> C(NodePath *, NodePath const *, TransformState const *, Thread *)
...
// _inCAAAAKELE : C++(NodePath const &other, TransformState const *transform) ==> C(NodePath *, NodePath const *, TransformState const *)
extern void NodePath$136$set_prev_transform(NodePath *self, NodePath const *other, TransformState const *transform);

// _inCAAAATR3n : C++(TransformState const *transform, Thread *current_thread) ==> C(NodePath *, TransformState const *, Thread *)
...
// _inCAAAAEAqj : C++(PN_stdfloat x, PN_stdfloat y, PN_stdfloat z, PN_stdfloat h, PN_stdfloat p, PN_stdfloat r) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAbZLS : C++(LVecBase3 const &pos, LQuaternion const &quat) ==> C(NodePath *, LVecBase3 const *, LQuaternion const *)
extern void NodePath$235$set_pos_quat(NodePath *self, LVecBase3 const *pos, LQuaternion const *quat);

// _inCAAAAOLQ7 : C++(NodePath const &other, LVecBase3 const &pos, LQuaternion const &quat) ==> C(NodePath *, NodePath const *, LVecBase3 const *, LQuaternion const *)
extern void NodePath$236$set_pos_quat(NodePath *self, NodePath const *other, LVecBase3 const *pos, LQuaternion const *quat);

// _inCAAAAbUjX : C++(LVecBase3 const &hpr, LVecBase3 const &scale) ==> C(NodePath *, LVecBase3 const *, LVecBase3 const *)
extern void NodePath$237$set_hpr_scale(NodePath *self, LVecBase3 const *hpr, LVecBase3 const *scale);

// _inCAAAAML6W : C++(NodePath const &other, LVecBase3 const &hpr, LVecBase3 const &scale) ==> C(NodePath *, NodePath const *, LVecBase3 const *, LVecBase3 const *)
extern void NodePath$238$set_hpr_scale(NodePath *self, NodePath const *other, LVecBase3 const *hpr, LVecBase3 const *scale);

// _inCAAAA1c4Y : C++(NodePath const &other, PN_stdfloat h, PN_stdfloat p, PN_stdfloat r, PN_stdfloat sx, PN_stdfloat sy, PN_stdfloat sz) ==> C(NodePath *, NodePath const *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAA7L8H : C++(PN_stdfloat h, PN_stdfloat p, PN_stdfloat r, PN_stdfloat sx, PN_stdfloat sy, PN_stdfloat sz) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAArl_T : C++(LQuaternion const &quat, LVecBase3 const &scale) ==> C(NodePath *, LQuaternion const *, LVecBase3 const *)
extern void NodePath$241$set_quat_scale(NodePath *self, LQuaternion const *quat, LVecBase3 const *scale);

// _inCAAAA_ZUg : C++(NodePath const &other, LQuaternion const &quat, LVecBase3 const &scale) ==> C(NodePath *, NodePath const *, LQuaternion const *, LVecBase3 const *)
extern void NodePath$242$set_quat_scale(NodePath *self, NodePath const *other, LQuaternion const *quat, LVecBase3 const *scale);

// _inCAAAAOMdP : C++(LVecBase3 const &pos, LVecBase3 const &hpr, LVecBase3 const &scale) ==> C(NodePath *, LVecBase3 const *, LVecBase3 const *, LVecBase3 const *)
extern void NodePath$243$set_pos_hpr_scale(NodePath *self, LVecBase3 const *pos, LVecBase3 const *hpr, LVecBase3 const *scale);

// _inCAAAAblzG : C++(NodePath const &other, LVecBase3 const &pos, LVecBase3 const &hpr, LVecBase3 const &scale) ==> C(NodePath *, NodePath const *, LVecBase3 const *, LVecBase3 const *, LVecBase3 const *)
...
// _inCAAAAIfbx : C++(NodePath const &other, PN_stdfloat x, PN_stdfloat y, PN_stdfloat z, PN_stdfloat h, PN_stdfloat p, PN_stdfloat r, PN_stdfloat sx, PN_stdfloat sy, PN_stdfloat sz) ==> C(NodePath *, NodePath const *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAG24J : C++(PN_stdfloat x, PN_stdfloat y, PN_stdfloat z, PN_stdfloat h, PN_stdfloat p, PN_stdfloat r, PN_stdfloat sx, PN_stdfloat sy, PN_stdfloat sz) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAu9HI : C++(LVecBase3 const &pos, LQuaternion const &quat, LVecBase3 const &scale) ==> C(NodePath *, LVecBase3 const *, LQuaternion const *, LVecBase3 const *)
...
// _inCAAAAch_2 : C++(NodePath const &other, LVecBase3 const &pos, LQuaternion const &quat, LVecBase3 const &scale) ==> C(NodePath *, NodePath const *, LVecBase3 const *, LQuaternion const *, LVecBase3 const *)
...
// _inCAAAAfHzz : C++(LVecBase3 const &pos, LVecBase3 const &hpr, LVecBase3 const &scale, LVecBase3 const &shear) ==> C(NodePath *, LVecBase3 const *, LVecBase3 const *, LVecBase3 const *, LVecBase3 const *)
...
// _inCAAAApHY1 : C++(NodePath const &other, LVecBase3 const &pos, LVecBase3 const &hpr, LVecBase3 const &scale, LVecBase3 const &shear) ==> C(NodePath *, NodePath const *, LVecBase3 const *, LVecBase3 const *, LVecBase3 const *, LVecBase3 const *)
...
// _inCAAAABeHo : C++(LVecBase3 const &pos, LQuaternion const &quat, LVecBase3 const &scale, LVecBase3 const &shear) ==> C(NodePath *, LVecBase3 const *, LQuaternion const *, LVecBase3 const *, LVecBase3 const *)
...
// _inCAAAAhGyX : C++(NodePath const &other, LVecBase3 const &pos, LQuaternion const &quat, LVecBase3 const &scale, LVecBase3 const &shear) ==> C(NodePath *, NodePath const *, LVecBase3 const *, LQuaternion const *, LVecBase3 const *, LVecBase3 const *)
...
// _inCAAAAFnWj : C++(LMatrix4 const &mat) ==> C(NodePath *, LMatrix4 const *)
extern void NodePath$253$set_mat(NodePath *self, LMatrix4 const *mat);

// _inCAAAAbult : C++(NodePath const &other, LMatrix4 const &mat) ==> C(NodePath *, NodePath const *, LMatrix4 const *)
extern void NodePath$254$set_mat(NodePath *self, NodePath const *other, LMatrix4 const *mat);

// _inCAAAAZ8BU : C++() ==> C(NodePath *)
extern void NodePath$255$clear_mat(NodePath *self);

// _inCAAAAuM1u : C++() ==> C(NodePath const *)
extern bool NodePath$256$has_mat(NodePath const *self);

// _inCAAAAIMoG : C++() ==> C(NodePath const *)
extern LMatrix4 const * NodePath$257$get_mat(NodePath const *self);

// _inCAAAA_p5g : C++(NodePath const &other) ==> C(NodePath const *, NodePath const *)
extern LMatrix4 * NodePath$258$get_mat(NodePath const *self, NodePath const *other);

// _inCAAAAfn8N : C++(LPoint3 const &point, LVector3 const &up) ==> C(NodePath *, LPoint3 const *, LVector3 const *)
extern void NodePath$259$look_at(NodePath *self, LPoint3 const *point, LVector3 const *up);

// _inCAAAA9LIH : C++(LPoint3 const &point) ==> C(NodePath *, LPoint3 const *)
extern void NodePath$260$look_at(NodePath *self, LPoint3 const *point);

// _inCAAAA8uIG : C++(NodePath const &other, LPoint3 const &point, LVector3 const &up) ==> C(NodePath *, NodePath const *, LPoint3 const *, LVector3 const *)
extern void NodePath$261$look_at(NodePath *self, NodePath const *other, LPoint3 const *point, LVector3 const *up);

// _inCAAAAn40q : C++(NodePath const &other, LPoint3 const &point) ==> C(NodePath *, NodePath const *, LPoint3 const *)
...
// _inCAAAA62Ls : C++(NodePath const &other) ==> C(NodePath *, NodePath const *)
...
// _inCAAAApYhi : C++(NodePath const &other, PN_stdfloat x, PN_stdfloat y, PN_stdfloat z) ==> C(NodePath *, NodePath const *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$264$look_at(NodePath *self, NodePath const *other, PN_stdfloat x, PN_stdfloat y, PN_stdfloat z);

// _inCAAAAz8_U : C++(PN_stdfloat x, PN_stdfloat y, PN_stdfloat z) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$265$look_at(NodePath *self, PN_stdfloat x, PN_stdfloat y, PN_stdfloat z);

// _inCAAAAfeLO : C++(LPoint3 const &point, LVector3 const &up) ==> C(NodePath *, LPoint3 const *, LVector3 const *)
extern void NodePath$266$heads_up(NodePath *self, LPoint3 const *point, LVector3 const *up);

// _inCAAAA1Hpz : C++(LPoint3 const &point) ==> C(NodePath *, LPoint3 const *)
extern void NodePath$267$heads_up(NodePath *self, LPoint3 const *point);

// _inCAAAA0GtV : C++(NodePath const &other, LPoint3 const &point, LVector3 const &up) ==> C(NodePath *, NodePath const *, LPoint3 const *, LVector3 const *)
extern void NodePath$268$heads_up(NodePath *self, NodePath const *other, LPoint3 const *point, LVector3 const *up);

// _inCAAAAqmcr : C++(NodePath const &other, LPoint3 const &point) ==> C(NodePath *, NodePath const *, LPoint3 const *)
...
// _inCAAAAwIWV : C++(NodePath const &other) ==> C(NodePath *, NodePath const *)
...
// _inCAAAANhpj : C++(NodePath const &other, PN_stdfloat x, PN_stdfloat y, PN_stdfloat z) ==> C(NodePath *, NodePath const *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$271$heads_up(NodePath *self, NodePath const *other, PN_stdfloat x, PN_stdfloat y, PN_stdfloat z);

// _inCAAAAUUnx : C++(PN_stdfloat x, PN_stdfloat y, PN_stdfloat z) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$272$heads_up(NodePath *self, PN_stdfloat x, PN_stdfloat y, PN_stdfloat z);

// _inCAAAADR9y : C++(NodePath const &other, LVecBase3 const &point) ==> C(NodePath const *, NodePath const *, LVecBase3 const *)
extern LPoint3 * NodePath$273$get_relative_point(NodePath const *self, NodePath const *other, LVecBase3 const *point);

// _inCAAAAqeF2 : C++(NodePath const &other, LVecBase3 const &vec) ==> C(NodePath const *, NodePath const *, LVecBase3 const *)
extern LVector3 * NodePath$274$get_relative_vector(NodePath const *self, NodePath const *other, LVecBase3 const *vec);

// _inCAAAAgctf : C++(NodePath const &other) ==> C(NodePath const *, NodePath const *)
extern PN_stdfloat NodePath$275$get_distance(NodePath const *self, NodePath const *other);

// _inCAAAAS0zC : C++(LColor const &color, int priority) ==> C(NodePath *, LColor const *, int)
extern void NodePath$276$set_color(NodePath *self, LColor const *color, int priority);

// _inCAAAASCGd : C++(LColor const &color) ==> C(NodePath *, LColor const *)
extern void NodePath$277$set_color(NodePath *self, LColor const *color);

// _inCAAAAOQ2g : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a, int priority) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, int)
extern void NodePath$278$set_color(NodePath *self, PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a, int priority);

// _inCAAAA5CWF : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$279$set_color(NodePath *self, PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a);

// _inCAAAAafsM : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$280$set_color(NodePath *self, PN_stdfloat r, PN_stdfloat g, PN_stdfloat b);

// _inCAAAAw27z : C++(int priority) ==> C(NodePath *, int)
extern void NodePath$281$set_color_off(NodePath *self, int priority);

// _inCAAAAE1gC : C++() ==> C(NodePath *)
extern void NodePath$282$set_color_off(NodePath *self);

// _inCAAAA1mr9 : C++() ==> C(NodePath *)
extern void NodePath$283$clear_color(NodePath *self);

// _inCAAAAbz4h : C++() ==> C(NodePath const *)
extern bool NodePath$284$has_color(NodePath const *self);

// _inCAAAAkzr5 : C++() ==> C(NodePath const *)
extern LColor * NodePath$285$get_color(NodePath const *self);

// _inCAAAAh9q2 : C++() ==> C(NodePath const *)
extern bool NodePath$286$has_color_scale(NodePath const *self);

// _inCAAAANGLo : C++() ==> C(NodePath *)
extern void NodePath$287$clear_color_scale(NodePath *self);

// _inCAAAAEUIg : C++(LVecBase4 const &scale, int priority) ==> C(NodePath *, LVecBase4 const *, int)
extern void NodePath$288$set_color_scale(NodePath *self, LVecBase4 const *scale, int priority);

// _inCAAAAd9dr : C++(LVecBase4 const &scale) ==> C(NodePath *, LVecBase4 const *)
extern void NodePath$289$set_color_scale(NodePath *self, LVecBase4 const *scale);

// _inCAAAAV6Aq : C++(PN_stdfloat sx, PN_stdfloat sy, PN_stdfloat sz, PN_stdfloat sa, int priority) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, int)
...
// _inCAAAA9niJ : C++(PN_stdfloat sx, PN_stdfloat sy, PN_stdfloat sz, PN_stdfloat sa) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$291$set_color_scale(NodePath *self, PN_stdfloat sx, PN_stdfloat sy, PN_stdfloat sz, PN_stdfloat sa);

// _inCAAAAmPCX : C++(LVecBase4 const &scale, int priority) ==> C(NodePath *, LVecBase4 const *, int)
extern void NodePath$292$compose_color_scale(NodePath *self, LVecBase4 const *scale, int priority);

// _inCAAAAKBwX : C++(LVecBase4 const &scale) ==> C(NodePath *, LVecBase4 const *)
extern void NodePath$293$compose_color_scale(NodePath *self, LVecBase4 const *scale);

// _inCAAAA6Th7 : C++(PN_stdfloat sx, PN_stdfloat sy, PN_stdfloat sz, PN_stdfloat sa, int priority) ==> C(NodePath *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, int)
...
// _inCAAAAUSy5 : C++(TextureStage *stage, Texture *tex, SamplerState const &sampler) ==> C(NodePath *, TextureStage *, Texture *, SamplerState const *)
extern void NodePath$355$set_texture(NodePath *self, TextureStage *stage, Texture *tex, SamplerState const *sampler);

// _inCAAAAgM3e : C++(TextureStage *stage, Texture *tex, int priority) ==> C(NodePath *, TextureStage *, Texture *, int)
...
// _inCAAAAtHou : C++(TextureStage *stage, Texture *tex) ==> C(NodePath *, TextureStage *, Texture *)
...
// _inCAAAAeAwP : C++(CPT_InternalName id, PN_stdfloat n1, PN_stdfloat n2, PN_stdfloat n3, PN_stdfloat n4) ==> C(NodePath *, CPT_InternalName *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAANiw4 : C++(CPT_InternalName id, PN_stdfloat n1, PN_stdfloat n2, PN_stdfloat n3) ==> C(NodePath *, CPT_InternalName *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$402$set_shader_input(NodePath *self, CPT_InternalName *id, PN_stdfloat n1, PN_stdfloat n2, PN_stdfloat n3);

// _inCAAAANVzy : C++(CPT_InternalName id, PN_stdfloat n1, PN_stdfloat n2) ==> C(NodePath *, CPT_InternalName *, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAveSm : C++(CPT_InternalName id, Texture *tex, SamplerState const &sampler) ==> C(NodePath *, CPT_InternalName *, Texture *, SamplerState const *)
extern void NodePath$429$set_shader_input(NodePath *self, CPT_InternalName *id, Texture *tex, SamplerState const *sampler);

// _inCAAAAHt_e : C++(CPT_InternalName id, Texture *tex, bool read, bool write, int z, int n, int priority) ==> C(NodePath *, CPT_InternalName *, Texture *, bool, bool, int, int, int)
...
// _inCAAAAr7f_ : C++(CPT_InternalName id, Texture *tex, bool read, bool write, int z, int n) ==> C(NodePath *, CPT_InternalName *, Texture *, bool, bool, int, int)
extern void NodePath$431$set_shader_input(NodePath *self, CPT_InternalName *id, Texture *tex, bool read, bool write, int z, int n);

// _inCAAAAhcRO : C++(CPT_InternalName id, Texture *tex, bool read, bool write, int z) ==> C(NodePath *, CPT_InternalName *, Texture *, bool, bool, int)
extern void NodePath$432$set_shader_input(NodePath *self, CPT_InternalName *id, Texture *tex, bool read, bool write, int z);

// _inCAAAAhAJW : C++(CPT_InternalName id, Texture *tex, bool read, bool write) ==> C(NodePath *, CPT_InternalName *, Texture *, bool, bool)
...
// _inCAAAA58hL : C++(CPT_InternalName id, int n1, int n2, int n3, int n4) ==> C(NodePath *, CPT_InternalName *, int, int, int, int)
extern void NodePath$437$set_shader_input(NodePath *self, CPT_InternalName *id, int n1, int n2, int n3, int n4);

// _inCAAAAWd4r : C++(CPT_InternalName id, int n1, int n2, int n3) ==> C(NodePath *, CPT_InternalName *, int, int, int)
extern void NodePath$438$set_shader_input(NodePath *self, CPT_InternalName *id, int n1, int n2, int n3);

// _inCAAAAP_Ec : C++(CPT_InternalName id, int n1, int n2) ==> C(NodePath *, CPT_InternalName *, int, int)
extern void NodePath$439$set_shader_input(NodePath *self, CPT_InternalName *id, int n1, int n2);

// _inCAAAAoLkB : C++(ShaderInput &&input) ==> C(NodePath *, ShaderInput *)
extern void NodePath$440$set_shader_input(NodePath *self, ShaderInput *input);

// _inCAAAA8uUt : C++(ShaderInput const &input) ==> C(NodePath *, ShaderInput const *)
...
// _inCAAAA_xqL : C++(CPT_InternalName id) ==> C(NodePath *, CPT_InternalName *)
extern void NodePath$442$clear_shader_input(NodePath *self, CPT_InternalName *id);

// _inCAAAAs3Az : C++(int instance_count) ==> C(NodePath *, int)
extern void NodePath$443$set_instance_count(NodePath *self, int instance_count);

// _inCAAAAXRer : C++() ==> C(NodePath const *)
extern Shader const * NodePath$444$get_shader(NodePath const *self);

// _inCAAAA1RQl : C++(CPT_InternalName id) ==> C(NodePath const *, CPT_InternalName *)
extern ShaderInput * NodePath$445$get_shader_input(NodePath const *self, CPT_InternalName *id);

// _inCAAAAFCMn : C++() ==> C(NodePath const *)
extern int NodePath$446$get_instance_count(NodePath const *self);

// _inCAAAAM5dH : C++(NodePath const &other, TextureStage *stage, TransformState const *transform) ==> C(NodePath *, NodePath const *, TextureStage *, TransformState const *)
...
// _inCAAAA7rVh : C++(TextureStage *stage, TransformState const *transform) ==> C(NodePath *, TextureStage *, TransformState const *)
extern void NodePath$448$set_tex_transform(NodePath *self, TextureStage *stage, TransformState const *transform);

// _inCAAAAPvbV : C++() ==> C(NodePath *)
extern void NodePath$449$clear_tex_transform(NodePath *self);

// _inCAAAA7hmM : C++(TextureStage *stage) ==> C(NodePath *, TextureStage *)
extern void NodePath$450$clear_tex_transform(NodePath *self, TextureStage *stage);

// _inCAAAAW20G : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern bool NodePath$451$has_tex_transform(NodePath const *self, TextureStage *stage);

// _inCAAAAkXI_ : C++(NodePath const &other, TextureStage *stage) ==> C(NodePath const *, NodePath const *, TextureStage *)
extern char ** NodePath$452$get_tex_transform(NodePath const *self, NodePath const *other, TextureStage *stage);

// _inCAAAAz2ne : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern char ** NodePath$453$get_tex_transform(NodePath const *self, TextureStage *stage);

// _inCAAAApJci : C++(NodePath const &other, TextureStage *stage, LVecBase2 const &uv) ==> C(NodePath *, NodePath const *, TextureStage *, LVecBase2 const *)
extern void NodePath$454$set_tex_offset(NodePath *self, NodePath const *other, TextureStage *stage, LVecBase2 const *uv);

// _inCAAAAsHUq : C++(NodePath const &other, TextureStage *stage, PN_stdfloat u, PN_stdfloat v) ==> C(NodePath *, NodePath const *, TextureStage *, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAgjDc : C++(TextureStage *stage, LVecBase2 const &uv) ==> C(NodePath *, TextureStage *, LVecBase2 const *)
extern void NodePath$456$set_tex_offset(NodePath *self, TextureStage *stage, LVecBase2 const *uv);

// _inCAAAA3n_9 : C++(TextureStage *stage, PN_stdfloat u, PN_stdfloat v) ==> C(NodePath *, TextureStage *, PN_stdfloat, PN_stdfloat)
extern void NodePath$457$set_tex_offset(NodePath *self, TextureStage *stage, PN_stdfloat u, PN_stdfloat v);

// _inCAAAAe6E_ : C++(NodePath const &other, TextureStage *stage, PN_stdfloat r) ==> C(NodePath *, NodePath const *, TextureStage *, PN_stdfloat)
extern void NodePath$458$set_tex_rotate(NodePath *self, NodePath const *other, TextureStage *stage, PN_stdfloat r);

// _inCAAAAfo1H : C++(TextureStage *stage, PN_stdfloat r) ==> C(NodePath *, TextureStage *, PN_stdfloat)
extern void NodePath$459$set_tex_rotate(NodePath *self, TextureStage *stage, PN_stdfloat r);

// _inCAAAAe3Ue : C++(NodePath const &other, TextureStage *stage, LVecBase2 const &scale) ==> C(NodePath *, NodePath const *, TextureStage *, LVecBase2 const *)
extern void NodePath$460$set_tex_scale(NodePath *self, NodePath const *other, TextureStage *stage, LVecBase2 const *scale);

// _inCAAAA6wZe : C++(NodePath const &other, TextureStage *stage, LVecBase3 const &scale) ==> C(NodePath *, NodePath const *, TextureStage *, LVecBase3 const *)
...
// _inCAAAAHGAD : C++(NodePath const &other, TextureStage *stage, PN_stdfloat scale) ==> C(NodePath *, NodePath const *, TextureStage *, PN_stdfloat)
extern void NodePath$462$set_tex_scale(NodePath *self, NodePath const *other, TextureStage *stage, PN_stdfloat scale);

// _inCAAAAxRiC : C++(NodePath const &other, TextureStage *stage, PN_stdfloat su, PN_stdfloat sv) ==> C(NodePath *, NodePath const *, TextureStage *, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAPifO : C++(NodePath const &other, TextureStage *stage, PN_stdfloat su, PN_stdfloat sv, PN_stdfloat sw) ==> C(NodePath *, NodePath const *, TextureStage *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAA6dKe : C++(TextureStage *stage, LVecBase2 const &scale) ==> C(NodePath *, TextureStage *, LVecBase2 const *)
extern void NodePath$465$set_tex_scale(NodePath *self, TextureStage *stage, LVecBase2 const *scale);

// _inCAAAADsLe : C++(TextureStage *stage, LVecBase3 const &scale) ==> C(NodePath *, TextureStage *, LVecBase3 const *)
...
// _inCAAAAawVn : C++(TextureStage *stage, PN_stdfloat scale) ==> C(NodePath *, TextureStage *, PN_stdfloat)
extern void NodePath$467$set_tex_scale(NodePath *self, TextureStage *stage, PN_stdfloat scale);

// _inCAAAACwLn : C++(TextureStage *stage, PN_stdfloat su, PN_stdfloat sv) ==> C(NodePath *, TextureStage *, PN_stdfloat, PN_stdfloat)
extern void NodePath$468$set_tex_scale(NodePath *self, TextureStage *stage, PN_stdfloat su, PN_stdfloat sv);

// _inCAAAAiKKq : C++(TextureStage *stage, PN_stdfloat su, PN_stdfloat sv, PN_stdfloat sw) ==> C(NodePath *, TextureStage *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$469$set_tex_scale(NodePath *self, TextureStage *stage, PN_stdfloat su, PN_stdfloat sv, PN_stdfloat sw);

// _inCAAAAtMN_ : C++(NodePath const &other, TextureStage *stage) ==> C(NodePath const *, NodePath const *, TextureStage *)
extern LVecBase2 * NodePath$470$get_tex_offset(NodePath const *self, NodePath const *other, TextureStage *stage);

// _inCAAAAOSVy : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern LVecBase2 * NodePath$471$get_tex_offset(NodePath const *self, TextureStage *stage);

// _inCAAAAgsWE : C++(NodePath const &other, TextureStage *stage) ==> C(NodePath const *, NodePath const *, TextureStage *)
extern PN_stdfloat NodePath$472$get_tex_rotate(NodePath const *self, NodePath const *other, TextureStage *stage);

// _inCAAAAF4f4 : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern PN_stdfloat NodePath$473$get_tex_rotate(NodePath const *self, TextureStage *stage);

// _inCAAAAhlUo : C++(NodePath const &other, TextureStage *stage) ==> C(NodePath const *, NodePath const *, TextureStage *)
extern LVecBase2 * NodePath$474$get_tex_scale(NodePath const *self, NodePath const *other, TextureStage *stage);

// _inCAAAA6J_f : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern LVecBase2 * NodePath$475$get_tex_scale(NodePath const *self, TextureStage *stage);

// _inCAAAATG_w : C++(NodePath const &other, TextureStage *stage, LVecBase3 const &uvw) ==> C(NodePath *, NodePath const *, TextureStage *, LVecBase3 const *)
extern void NodePath$476$set_tex_pos(NodePath *self, NodePath const *other, TextureStage *stage, LVecBase3 const *uvw);

// _inCAAAAru67 : C++(NodePath const &other, TextureStage *stage, PN_stdfloat u, PN_stdfloat v, PN_stdfloat w) ==> C(NodePath *, NodePath const *, TextureStage *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAHtN9 : C++(TextureStage *stage, LVecBase3 const &uvw) ==> C(NodePath *, TextureStage *, LVecBase3 const *)
extern void NodePath$478$set_tex_pos(NodePath *self, TextureStage *stage, LVecBase3 const *uvw);

// _inCAAAAfj4v : C++(TextureStage *stage, PN_stdfloat u, PN_stdfloat v, PN_stdfloat w) ==> C(NodePath *, TextureStage *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$479$set_tex_pos(NodePath *self, TextureStage *stage, PN_stdfloat u, PN_stdfloat v, PN_stdfloat w);

// _inCAAAAuhsY : C++(NodePath const &other, TextureStage *stage, LVecBase3 const &hpr) ==> C(NodePath *, NodePath const *, TextureStage *, LVecBase3 const *)
extern void NodePath$480$set_tex_hpr(NodePath *self, NodePath const *other, TextureStage *stage, LVecBase3 const *hpr);

// _inCAAAAmLpj : C++(NodePath const &other, TextureStage *stage, PN_stdfloat h, PN_stdfloat p, PN_stdfloat r) ==> C(NodePath *, NodePath const *, TextureStage *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAaI7k : C++(TextureStage *stage, LVecBase3 const &hpr) ==> C(NodePath *, TextureStage *, LVecBase3 const *)
extern void NodePath$482$set_tex_hpr(NodePath *self, TextureStage *stage, LVecBase3 const *hpr);

// _inCAAAABykX : C++(TextureStage *stage, PN_stdfloat h, PN_stdfloat p, PN_stdfloat r) ==> C(NodePath *, TextureStage *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePath$483$set_tex_hpr(NodePath *self, TextureStage *stage, PN_stdfloat h, PN_stdfloat p, PN_stdfloat r);

// _inCAAAAJ7Vi : C++(NodePath const &other, TextureStage *stage) ==> C(NodePath const *, NodePath const *, TextureStage *)
extern LVecBase3 * NodePath$484$get_tex_pos(NodePath const *self, NodePath const *other, TextureStage *stage);

// _inCAAAApg2Y : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern LVecBase3 * NodePath$485$get_tex_pos(NodePath const *self, TextureStage *stage);

// _inCAAAAH0DK : C++(NodePath const &other, TextureStage *stage) ==> C(NodePath const *, NodePath const *, TextureStage *)
extern LVecBase3 * NodePath$486$get_tex_hpr(NodePath const *self, NodePath const *other, TextureStage *stage);

// _inCAAAA_wiA : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern LVecBase3 * NodePath$487$get_tex_hpr(NodePath const *self, TextureStage *stage);

// _inCAAAAbZgd : C++(NodePath const &other, TextureStage *stage) ==> C(NodePath const *, NodePath const *, TextureStage *)
extern LVecBase3 * NodePath$488$get_tex_scale_3d(NodePath const *self, NodePath const *other, TextureStage *stage);

// _inCAAAAKAhK : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern LVecBase3 * NodePath$489$get_tex_scale_3d(NodePath const *self, TextureStage *stage);

// _inCAAAAdzav : C++(TextureStage *stage, RenderAttrib::TexGenMode mode, LTexCoord3 const &constant_value, int priority) ==> C(NodePath *, TextureStage *, RenderAttrib::TexGenMode, LTexCoord3 const *, int)
...
// _inCAAAAb0sJ : C++(TextureStage *stage, RenderAttrib::TexGenMode mode, LTexCoord3 const &constant_value) ==> C(NodePath *, TextureStage *, RenderAttrib::TexGenMode, LTexCoord3 const *)
...
// _inCAAAAEZu2 : C++(TextureStage *stage, RenderAttrib::TexGenMode mode, int priority) ==> C(NodePath *, TextureStage *, RenderAttrib::TexGenMode, int)
extern void NodePath$492$set_tex_gen(NodePath *self, TextureStage *stage, RenderAttrib$_TexGenMode mode, int priority);

// _inCAAAAz8w0 : C++(TextureStage *stage, RenderAttrib::TexGenMode mode) ==> C(NodePath *, TextureStage *, RenderAttrib::TexGenMode)
extern void NodePath$493$set_tex_gen(NodePath *self, TextureStage *stage, RenderAttrib$_TexGenMode mode);

// _inCAAAAiojB : C++() ==> C(NodePath *)
extern void NodePath$494$clear_tex_gen(NodePath *self);

// _inCAAAAY_YK : C++(TextureStage *stage) ==> C(NodePath *, TextureStage *)
extern void NodePath$495$clear_tex_gen(NodePath *self, TextureStage *stage);

// _inCAAAAePbA : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern bool NodePath$496$has_tex_gen(NodePath const *self, TextureStage *stage);

// _inCAAAA7MOY : C++(TextureStage *stage) ==> C(NodePath const *, TextureStage *)
extern RenderAttrib$_TexGenMode NodePath$497$get_tex_gen(NodePath const *self, TextureStage *stage);

// _inCAAAAIC4h : C++(TextureStage *stage, NodePath const &from, NodePath const &to, int lens_index) ==> C(NodePath *, TextureStage *, NodePath const *, NodePath const *, int)
...
// _inCAAAA9VpQ : C++(CollideMask new_mask, CollideMask bits_to_change) ==> C(NodePathCollection *, CollideMask *, CollideMask *)
...
// _inCAAAAJbTl : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a) ==> C(NodePathCollection *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAA1ZcC : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b) ==> C(NodePathCollection *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePathCollection$45$set_color(NodePathCollection *self, PN_stdfloat r, PN_stdfloat g, PN_stdfloat b);

// _inCAAAAuxPQ : C++(LVecBase4 const &scale, int priority) ==> C(NodePathCollection *, LVecBase4 const *, int)
extern void NodePathCollection$46$set_color_scale(NodePathCollection *self, LVecBase4 const *scale, int priority);

// _inCAAAAVyZ9 : C++(LVecBase4 const &scale) ==> C(NodePathCollection *, LVecBase4 const *)
extern void NodePathCollection$47$set_color_scale(NodePathCollection *self, LVecBase4 const *scale);

// _inCAAAA9e_3 : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a, int priority) ==> C(NodePathCollection *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, int)
...
// _inCAAAASlA2 : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a) ==> C(NodePathCollection *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAL9t9 : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b) ==> C(NodePathCollection *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePathCollection$50$set_color_scale(NodePathCollection *self, PN_stdfloat r, PN_stdfloat g, PN_stdfloat b);

// _inCAAAAcI2r : C++(LVecBase4 const &scale, int priority) ==> C(NodePathCollection *, LVecBase4 const *, int)
extern void NodePathCollection$51$compose_color_scale(NodePathCollection *self, LVecBase4 const *scale, int priority);

// _inCAAAAiItu : C++(LVecBase4 const &scale) ==> C(NodePathCollection *, LVecBase4 const *)
extern void NodePathCollection$52$compose_color_scale(NodePathCollection *self, LVecBase4 const *scale);

// _inCAAAApaP_ : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a, int priority) ==> C(NodePathCollection *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat, int)
...
// _inCAAAAWpGG : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b, PN_stdfloat a) ==> C(NodePathCollection *, PN_stdfloat, PN_stdfloat, PN_stdfloat, PN_stdfloat)
...
// _inCAAAAFyp6 : C++(PN_stdfloat r, PN_stdfloat g, PN_stdfloat b) ==> C(NodePathCollection *, PN_stdfloat, PN_stdfloat, PN_stdfloat)
extern void NodePathCollection$55$compose_color_scale(NodePathCollection *self, PN_stdfloat r, PN_stdfloat g, PN_stdfloat b);

// _inCAAAAWzN6 : C++(RenderAttrib const *attrib, int priority) ==> C(NodePathCollection *, RenderAttrib const *, int)
extern void NodePathCollection$56$set_attrib(NodePathCollection *self, RenderAttrib const *attrib, int priority);

// _inCAAAAkrMD : C++(RenderAttrib const *attrib) ==> C(NodePathCollection *, RenderAttrib const *)
extern void NodePathCollection$57$set_attrib(NodePathCollection *self, RenderAttrib const *attrib);

// _inCAAAAGpQO : C++(std::ostream &out) ==> C(NodePathCollection const *, std::ostream *)
extern void NodePathCollection$58$output(NodePathCollection const *self, std$_ostream *out);

// _inCAAAAvAND : C++(std::ostream &out, int indent_level) ==> C(NodePathCollection const *, std::ostream *, int)
extern void NodePathCollection$59$write(NodePathCollection const *self, std$_ostream *out, int indent_level);

// _inCAAAA_djl : C++(std::ostream &out) ==> C(NodePathCollection const *, std::ostream *)
...
// _inCAAAA4lUs : C++(WindowProperties const &props, int flags, GraphicsPipe *pipe) ==> C(PandaFramework *, WindowProperties const *, int, GraphicsPipe *)
...
// _inCAAAA2W_P : C++(TypeHandle type) ==> C(PandaNode const *, int)
extern bool PandaNode$85$has_attrib(PandaNode const *self, int type);

// _inCAAAAuInU : C++(int slot) ==> C(PandaNode const *, int)
...
// _inCAAAADSEu : C++(TypeHandle type) ==> C(PandaNode *, int)
extern void PandaNode$87$clear_attrib(PandaNode *self, int type);

// _inCAAAAWqh9 : C++(int slot) ==> C(PandaNode *, int)
...
// _inCAAAAZIxB : C++(BamWriter *manager, Datagram &dg) ==> C(PandaNode *, BamWriter *, Datagram *)
extern void PandaNode$201$write_datagram(PandaNode *self, BamWriter *manager, Datagram *dg);

// _inCAAAA6DZU : C++(BamWriter *manager) ==> C(PandaNode *, BamWriter *)
extern void PandaNode$202$update_bam_nested(PandaNode *self, BamWriter *manager);

// _inCAAAAB3Ta : C++(BamWriter *manager, Datagram &dg) ==> C(PandaNode *, BamWriter *, Datagram *)
...
// _inCAAAAZbhg : C++() ==> C(PandaNode const *)
...
// _inCAAAA3E_r : C++() ==> C()
extern char const * PandaSystem$2$get_package_version_string(void);

// _inCAAAAFXHg : C++() ==> C()
extern char const * PandaSystem$3$get_package_host_url(void);

// _inCAAAA_hDl : C++() ==> C()
extern char const * PandaSystem$4$get_p3d_coreapi_version_string(void);

// _inCAAAAlpKc : C++() ==> C()
extern int PandaSystem$5$get_major_version(void);

// _inCAAAAB4NU : C++() ==> C()
extern int PandaSystem$6$get_minor_version(void);

// _inCAAAAoXlJ : C++() ==> C()
extern int PandaSystem$7$get_sequence_version(void);

// _inCAAAACKGJ : C++() ==> C()
extern bool PandaSystem$8$is_official_version(void);

// _inCAAAA_9Ms : C++() ==> C()
extern int PandaSystem$9$get_memory_alignment(void);

// _inCAAAAu2tG : C++() ==> C()
extern char const * PandaSystem$10$get_distributor(void);

// _inCAAAAcM8j : C++() ==> C()
extern char const * PandaSystem$11$get_compiler(void);

// _inCAAAAPPs0 : C++() ==> C()
extern char const * PandaSystem$12$get_build_date(void);

// _inCAAAAxlmj : C++() ==> C()
extern char const * PandaSystem$13$get_git_commit(void);

// _inCAAAA9Y1A : C++() ==> C()
extern char const * PandaSystem$14$get_platform(void);

// _inCAAAAMn7K : C++(std::string const &system) ==> C(PandaSystem const *, char const *)
extern bool PandaSystem$15$has_system(PandaSystem const *self, char const *system);

// _inCAAAAcMuF : C++() ==> C(PandaSystem const *)
extern std$_size_t PandaSystem$16$get_num_systems(PandaSystem const *self);

// _inCAAAATSlk : C++(std::size_t n) ==> C(PandaSystem const *, std::size_t)
extern char const * PandaSystem$17$get_system(PandaSystem const *self, std$_size_t n);

// _inCAAAAv2z_ : C++(std::string const &system, std::string const &tag) ==> C(PandaSystem const *, char const *, char const *)
extern char const * PandaSystem$18$get_system_tag(PandaSystem const *self, char const *system, char const *tag);

// _inCAAAAu_FG : C++(std::string const &system) ==> C(PandaSystem *, char const *)
extern void PandaSystem$19$add_system(PandaSystem *self, char const *system);

// _inCAAAA3vBP : C++(std::string const &system, std::string const &tag, std::string const &value) ==> C(PandaSystem *, char const *, char const *, char const *)
extern void PandaSystem$20$set_system_tag(PandaSystem *self, char const *system, char const *tag, char const *value);

// _inCAAAAp7d3 : C++(std::size_t pad) ==> C(PandaSystem *, std::size_t)
extern bool PandaSystem$21$heap_trim(PandaSystem *self, std$_size_t pad);

// _inCAAAAcfNj : C++(std::ostream &out) ==> C(PandaSystem const *, std::ostream *)
extern void PandaSystem$22$output(PandaSystem const *self, std$_ostream *out);

// _inCAAAA__e5 : C++(std::ostream &out) ==> C(PandaSystem const *, std::ostream *)
extern void PandaSystem$23$write(PandaSystem const *self, std$_ostream *out);

// _inCAAAAF_U4 : C++() ==> C()
extern PandaSystem * PandaSystem$24$get_global_ptr(void);

// _inCAAAAO5cE : C++() ==> C()
extern int PandaSystem$25$get_class_type(void);

// _inCAAAAx_BK : C++() ==> C()
extern void PandaSystem$26$init_type(void);


// ReferenceCount

// _inCAAAA5zFh : C++() ==> C(ReferenceCount *)
extern MemoryBase * ReferenceCount$1$upcast_to_MemoryBase(ReferenceCount *self);

// _inCAAAAP11_ : C++() ==> C(ReferenceCount const *)
extern int ReferenceCount$2$get_ref_count(ReferenceCount const *self);

// _inCAAAAaS5_ : C++() ==> C(ReferenceCount const *)
extern void ReferenceCount$3$ref(ReferenceCount const *self);

// _inCAAAAwyVy : C++() ==> C(ReferenceCount const *)
extern bool ReferenceCount$4$unref(ReferenceCount const *self);

// _inCAAAAvpj2 : C++() ==> C(ReferenceCount const *)
extern bool ReferenceCount$5$test_ref_count_integrity(ReferenceCount const *self);

// _inCAAAAtT6g : C++() ==> C(ReferenceCount const *)
extern bool ReferenceCount$6$test_ref_count_nonzero(ReferenceCount const *self);

// _inCAAAATZpk : C++() ==> C(ReferenceCount *)
extern void ReferenceCount$7$local_object(ReferenceCount *self);

// _inCAAAALXVj : C++() ==> C(ReferenceCount const *)
extern bool ReferenceCount$8$has_weak_list(ReferenceCount const *self);

// _inCAAAAjKVW : C++() ==> C(ReferenceCount const *)
extern WeakReferenceList * ReferenceCount$9$get_weak_list(ReferenceCount const *self);

// _inCAAAADxOx : C++() ==> C(ReferenceCount *)
extern WeakReferenceList * ReferenceCount$10$weak_ref(ReferenceCount *self);

// _inCAAAALN15 : C++() ==> C(ReferenceCount *)
extern void ReferenceCount$11$weak_unref(ReferenceCount *self);

// _inCAAAA5NW5 : C++() ==> C(ReferenceCount const *)
extern bool ReferenceCount$12$ref_if_nonzero(ReferenceCount const *self);

// _inCAAAAn3ZO : C++() ==> C()
extern int ReferenceCount$13$get_class_type(void);
...
// _inCAAAAEK72 : C++(double seconds) ==> C(double)
...
// _inCAAAAxNNE : C++() ==> C(Thread const *)
extern int Thread$37$get_type(Thread const *self);

// _inCAAAAGz5S : C++() ==> C(Thread *)
...
// _inCAAAAlbzG : C++() ==> C(TypedWritable *)
...
// _inCAAAACIRR : C++() ==> C(WindowFramework *)
...
// _inCAAAAvhbO : C++() ==> C(WindowFramework const *)
extern int WindowFramework$50$get_type(WindowFramework const *self);

// _inCAAAAi4Rg : C++() ==> C(WindowFramework *)
